...
public class SecurityMonitor {
     ...
     *
     * what to do: executed operations should be the same at 2f+1 replicas. As
     * they are the same everywhere we should be able to perform the missing
     * operations and continue
     *
     * everything before "2f+1 prepared operations" should be able to be redone
     * by resetting the transactions/operations state to INCOMING and forcing
     * the new primary to resend the PREPREPARE message with n =
     * max(sequence)+1. This will lead to holes in our sequence numbers -- but
    ...
    /**
     * TODO: this should be called if my execution log seems to be running
     * behind the other replicas
     *
     * @return
     */
    ...
    /**
     * a checkpoint message was not consistent with already received checkpoint
     * messages
     *
     * @param msg
     */
