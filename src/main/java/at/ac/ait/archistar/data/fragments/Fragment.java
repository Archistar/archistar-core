...
public interface Fragment {
	...
	/** @return is this fragment already stored/synced with the
	 *          backend? storage server
	 */
	boolean isSynchronized();
	
	/**
	 * @param set the synchronized state (is the fragment in-sync with
	 *        the storage server side representation) to true
